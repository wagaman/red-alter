 ...
 */
@ControllerAdvice({"com.bbd.dafei.web.controller","com.components.web.controller"})
public class RaHandlerException {


    private static Logger LOGGER = LoggerFactory.getLogger(RaHandlerException.class);
